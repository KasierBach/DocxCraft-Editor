export const docsEn = {
  ...
  config: {
    ...
    variables: {
      ...
      maxDocumentsPerUser: 'Per-account document limit (hosted accounts only)',
      maxStoragePerUser: 'Per-account storage limit in bytes (hosted accounts only)',
...
export const docsVi: DocsMessages = {
  ...
  config: {
    ...
    variables: {
      ...
      maxDocumentsPerUser: 'Giới hạn số tài liệu mỗi tài khoản (chỉ chế độ có tài khoản)',
      maxStoragePerUser: 'Giới hạn dung lượng mỗi tài khoản theo byte (chỉ chế độ có tài khoản)',
